...
class DualSpaceKDWithCMA_OT_3(VariousDivergence):
    def __init__(self, args, padding_id=-100):
        ...
        self.ot_weight_logits = 70.0
        self.ot_weight_hidden = 120.0
        self.kd_rate = 1.5
        self.tau_seq = 2.0
        self.top_k_vocab = 15
        ...
        # self.etp = ETP_1()
        self.etp = ETP()
        self.cost_weights_logits = nn.Parameter(torch.tensor([0.5, 0.2, 0.3], dtype=self.dtype, device=self.device))
