...
#                 # Add
#                 required_logits_keys = ["avg_c1_logits", "avg_c2_logits", "avg_c4_logits", "avg_c6_logits"]
#                 required_hidden_keys = ["avg_c_embed_hidden", "avg_c_ctx_hidden"]
...
#                             to_scalar(batch_logging_output["avg_c1_logits"]),
#                             to_scalar(batch_logging_output["avg_c2_logits"]),
#                             to_scalar(batch_logging_output["avg_c4_logits"]),
#                             to_scalar(batch_logging_output["avg_c6_logits"])
#                         ]
#                         cost_values_hidden = [
#                             to_scalar(batch_logging_output["avg_c_embed_hidden"]),
#                             to_scalar(batch_logging_output["avg_c_ctx_hidden"])
#                         ]
    ...
    for epoch in range(args.num_epochs):
        ...
        while True:
            ...
            for batch in global_batch:
                ...
                # Add
                required_last_keys = ["avg_c_had_last", "avg_c_seq_last", "avg_c2_last", "avg_c4_last", "avg_c5_last"]

                if all(k in batch_logging_output for k in required_last_keys):
                    def to_scalar(value):
                        if isinstance(value, (int, float)):
                            return float(value)
                        elif isinstance(value, (list, tuple)):
                    ...
                    try:
                        cost_values_last = [
                            to_scalar(batch_logging_output["avg_c_had_last"]),
                            to_scalar(batch_logging_output["avg_c_seq_last"]),
